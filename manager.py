...
def banner():
    ...
    print(f'{lg}Version: {w}2.0{lg} | GitHub: {w}@saifalisew1508')
    print(f'{lg}Telegram: {w}@DearSaif{lg} | Instagram: {w}@_Prince.Babu')
    ...
    if a == 1:
        ...
        with open('vars.txt', 'ab') as g:
            ...
            for number in new_accs:
                c = TelegramClient(f'sessions/{number}', 22772855, 'eca4e92a2a270486fc052f724b91906a')
                c.start(number)
